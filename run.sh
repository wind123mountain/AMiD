...
bash scripts/distillm-nnm/qwen2.5/train_qwen2.5_1.5B_it_1e_ablation.sh nnm
...
bash scripts/distillm-nnm/gemma2/train_qwen3_it_2e.sh
bash scripts/distillm-nnm/gemma2/train_qwen3_it_2e_2.sh
bash scripts/distillm-nnm/gemma2/train_qwen3_it_2e_3.sh
