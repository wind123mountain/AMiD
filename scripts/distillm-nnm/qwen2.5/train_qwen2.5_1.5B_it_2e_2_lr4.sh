...
SAVE_PATH="./results/${CKPT_NAME}#sfkl_nnm_lora/nnm_new_finetune_4_${NNM_RATIO}_K${NNM_K}_L${NNM_N_LAYERS}_epoch${EPOCHS}_lr${LR}_kdr${KD_R}"
...
export PYTHONPATH=.
CMD="torchrun ${DISTRIBUTED_ARGS} ./finetune_4.py ${OPTS} $@"
