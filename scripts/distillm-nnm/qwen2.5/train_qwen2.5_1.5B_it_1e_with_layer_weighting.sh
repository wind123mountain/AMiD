...
SAVE_PATH="./results/${CKPT_NAME}#sfkl_nnm_lw/nnm${NNM_RATIO}_K${NNM_K}_L${NNM_N_LAYERS}_epoch${EPOCHS}_lr${LR}_kdr${KD_R}"
...
export PYTHONPATH=.
CMD="torchrun ${DISTRIBUTED_ARGS} ./finetune_with_layer_weighting.py ${OPTS} $@"
